...
public class OAuth2IdentityProvider
    extends AbstractOAuth2IdentityProvider<OAuth2ScriptedProviderConfig>
  ...
  public OAuth2IdentityProvider(KeycloakSession session, OAuth2ScriptedProviderConfig config) {
