...
public class StripConnectUserAttributeMapper extends AbstractJsonUserAttributeMapper {

    public static final String PROVIDER_ID = "stripe-connect-user-attribute-mapper";
    private static final String[] cp = new String[] {StripeConnectIdentityProviderFactory.PROVIDER_ID};

    public StripConnectUserAttributeMapper() {
        super();
