...
public class StripeConnectScriptedProviderConfig extends OAuth2IdentityProviderConfig {

  private static final String IDENTITY_SCRIPT = "identityScript";
  public static final String TOKEN_URL = "tokenUrl";
  public static final String AUTHORIZATION_URL = "authorizationUrl";

  public StripeConnectScriptedProviderConfig(IdentityProviderModel model) {
    super(model);
  }

  public StripeConnectScriptedProviderConfig() {}
    ...
    return ProviderConfigurationBuilder.create()
        ...
        .helpText(
            "Script to compute the user identity. \n"
                ...
                + " 'stripe_user_id' - the id obtained from Stripe.\n\n"
